...
try {
    ...
    $mail->Username   = 'cotizaciones@gduma.com';                     // SMTP username
    $mail->Password   = 'etuznpdnaheqarkv';                               // SMTP password
    $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;         // Enable TLS encryption; `PHPMailer::ENCRYPTION_SMTPS` encouraged
    $mail->Port       = 587;                                    // TCP port to connect to, use 465 for `PHPMailer::ENCRYPTION_SMTPS` above

    //Recipients
    $mail->addAddress('cotizaciones@gduma.com', 'DUMA'); 
    ...
    <body>
        <table style="border: 1px solid black;width: 100%;">
            <thead>
                ...
                <tr><th align="center" style="text-align: center;" ><span style="font-size: 15px;">'.utf8_decode('Email: '.$email ).'</span></th></tr>
